...
// Don't forget the "y" sticky flag on regex or different words trigger gn or gm.
   ...
   if (msg.author.bot){ 
      return; 
   } else if(/good morning|good mornin|^gm $|[^A-Za-z0-9]gm .*[^A-Za-z0-9_@]$|mornin|morning/yi.test(msg.content)){
      msg.reply('GM' + getRandomEmojiGM());
   } else if(/good night|nite|g\'nite|^gn $|[^A-Za-z0-9_@]gn .*[^A-Za-z0-9_@]$|night/yi.test(msg.content)){
