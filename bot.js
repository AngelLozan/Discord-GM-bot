...
.then(() => {
   if(msg.content.toLowerCase().includes('help') && msg.content.includes('<@980457022971600936>')) {
      ...
      return;
   } else if(msg.content.toLowerCase().includes('thanks')|| msg.content.toLowerCase().includes('thank you') || msg.content.toLowerCase().includes('thx') && msg.content.includes('<@980457022971600936>')) {
         msg.react('💙');
         msg.channel.startTyping();
         setTimeout(() => {
